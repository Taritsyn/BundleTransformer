namespace BundleTransformer.Autoprefixer.AutoPrefixers
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <code>BundleTransformer.Autoprefixer.Autoprefixers.CssAutoPrefixingException</code>
		/// class with a specified error message
		/// </summary>
		/// <param name="message">The message that describes the error</param>
		public CssAutoprefixingException(string message)
			: base(message)
		{ }
		...
		public CssAutoprefixingException(string message, Exception innerException)
