...
move %packages_directory%\BundleTransformer.Hogan\*.nupkg %repository_directory%
move %packages_directory%\BundleTransformer.Handlebars\*.nupkg %repository_directory%
move %packages_directory%\BundleTransformer.Autoprefixer\*.nupkg %repository_directory%
...
move %packages_directory%\BundleTransformer.CleanCss\*.nupkg %repository_directory%