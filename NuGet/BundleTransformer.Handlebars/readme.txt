   ...
   ----------------------------------------------------------------------
            README file for Bundle Transformer: Handlebars 1.9.52
   ...
   version 3.0.1). This adapter makes translation of Handlebars-templates
   ...
   RELEASE NOTES
   =============
   Added support of Handlebars version 3.0.1.
