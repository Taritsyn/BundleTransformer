   ...
   ----------------------------------------------------------------------
            README file for Bundle Transformer: Handlebars 1.9.76
   ...
   version 4.0.3). This adapter makes translation of Handlebars-templates
   ...
   RELEASE NOTES
   =============
   Added support of Handlebars version 4.0.3.
