   ...
   ----------------------------------------------------------------------
             README file for Bundle Transformer: Clean-css 1.9.52
   ...
   RELEASE NOTES
   =============
   1. Added support of Clean-css version 3.1.8;
   2. In configuration settings of CSS-minifier was added 2 new
      properties: `MediaMerging` (default `true`) and `Restructuring`
      (default `true`).
