   ...
   --------------------------------------------------------------------------------
               README file for Bundle Transformer: Autoprefixer v1.9.206
   ...
   (https://github.com/postcss/autoprefixer) version 8.5.2.
   ...
   RELEASE NOTES
   =============
   Added support of Autoprefixer version 8.5.2.
