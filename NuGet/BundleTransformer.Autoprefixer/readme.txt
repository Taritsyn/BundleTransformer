   ...
   --------------------------------------------------------------------------------
               README file for Bundle Transformer: Autoprefixer v1.9.186
   ...
   (https://github.com/postcss/autoprefixer) version 7.2.5.
   ...
   RELEASE NOTES
   =============
   Added support of Autoprefixer version 7.2.5.
