   ...
   ----------------------------------------------------------------------
           README file for Bundle Transformer: Autoprefixer 1.9.65
   ...
   Autoprefixer (http://github.com/postcss/autoprefixer) version 5.2.
   ...
   RELEASE NOTES
   =============
   1. Added support of Autoprefixer version 5.2;
   2. In configuration settings added new property - `Add`
      (default `true`).
