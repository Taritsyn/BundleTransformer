   ...
   --------------------------------------------------------------------------------
               README file for Bundle Transformer: CoffeeScript v1.9.126
   ...
   version 1.11.1). This adapter makes translation of CoffeeScript-code to JS-code.
   ...
   RELEASE NOTES
   =============
   Added support of CoffeeScript version 1.11.1.
