   ...
   ----------------------------------------------------------------------
           README file for Bundle Transformer: CoffeeScript 1.9.55
   ...
   version 1.9.1). This adapter makes translation of CoffeeScript-code 
   ...
   RELEASE NOTES
   =============
   CoffeeScript was updated to commit bd17cc9b3c.
