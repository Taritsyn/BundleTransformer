   ...
   --------------------------------------------------------------------------------
               README file for Bundle Transformer: CoffeeScript v1.9.182
   ...
   version 2.0.3). This adapter makes translation of CoffeeScript code to JS code.
   ...
   RELEASE NOTES
   =============
   Added support of CoffeeScript version 2.0.3.
