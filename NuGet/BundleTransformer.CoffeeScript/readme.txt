   ...
   ----------------------------------------------------------------------
           README file for Bundle Transformer: CoffeeScript 1.9.43
   ...
   version 1.9.0). This adapter makes translation of CoffeeScript-code 
   ...
   RELEASE NOTES
   =============
   Added support of CoffeeScript version 1.9.0.
