   ...
   --------------------------------------------------------------------------------
               README file for Bundle Transformer: CoffeeScript v1.9.146
   ...
   version 1.12.3). This adapter makes translation of CoffeeScript-code to JS-code.
   ...
   RELEASE NOTES
   =============
   Added support of CoffeeScript version 1.12.3.
