   ...
   ----------------------------------------------------------------------
      README file for Bundle Transformer: CoffeeScript v1.9.122 Alpha 1
   ...
   version 1.10.0). This adapter makes translation of CoffeeScript-code
   ...
   `/configuration/bundleTransformer/coffeeScript/jsEngine` configuration
   element.
