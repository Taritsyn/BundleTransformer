   ...
   --------------------------------------------------------------------------------
              README file for Bundle Transformer: Microsoft Ajax v1.9.92
   ...
   minification using the Microsoft Ajax Minifier (http://ajaxmin.codeplex.com).
   ...
   changes to the Web.config file. In `defaultMinifier` attribute of element
