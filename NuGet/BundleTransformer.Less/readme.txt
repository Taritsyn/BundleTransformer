   ...
   --------------------------------------------------------------------------------
                   README file for Bundle Transformer: LESS v1.9.201
   ...
   (supports the LESS (http://lesscss.org) version 3.0.2). This adapter makes
   ...
   RELEASE NOTES
   =============
   Added support of LESS version 3.0.2.
