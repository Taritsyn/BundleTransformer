   ...
   ----------------------------------------------------------------------
           README file for Bundle Transformer: LESS 1.9.0 Beta 2
   ...
   (supports LESS (http://lesscss.org) version 1.7.1). This adapter makes
   ...
   RELEASE NOTES
   =============
   Added support of LESS version 1.7.1.
