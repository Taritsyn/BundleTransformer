   ...
   ----------------------------------------------------------------------
           README file for Bundle Transformer: LESS 1.9.92 Alpha 5
   ...
   (supports LESS (http://lesscss.org) version 2.6.0). This adapter makes
   ...
   RELEASE NOTES
   =============
   Added support of LESS version 2.6.0.
