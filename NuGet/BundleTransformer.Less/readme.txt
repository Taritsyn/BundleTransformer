   ...
   --------------------------------------------------------------------------------
                   README file for Bundle Transformer: LESS v1.9.192
   ...
   (supports the LESS (http://lesscss.org) version 3.0.1). This adapter makes
   ...
   RELEASE NOTES
   =============
   Added support of LESS version 3.0.1.
