 ...
 * In BundleTransformer.NUglify added support for the NUglify version 1.23.1

## v1.17.6 - September 10, 2026
 * In BundleTransformer.SassAndScss added support for the Dart Sass version 1.104.0
 * In BundleTransformer.Autoprefixer added support for the Autoprefixer version 10.5.5
 * In BundleTransformer.NUglify added support for the NUglify version 1.23.0
 ...
 * In BundleTransformer.NUglify added support for the NUglify version 1.22.3
...
## v1.13.12 - August 27, 2023
 * In BundleTransformer.SassAndScss added support for the Dart Sass version 1.66.1
 * In BundleTransformer.TypeScript added support for the TypeScript version 5.2 RTM (please note: The 5.2 RTM release is also called '5.2.2')
