   ...
   (https://github.com/Taritsyn/DartSassHost) version 1.0.5 (supports the Dart Sass
   (https://github.com/sass/dart-sass) version 1.64.1). Also contains the
   ...
   RELEASE NOTES
   =============
   Added support for the Dart Sass version 1.64.1.
