   ...
   --------------------------------------------------------------------------------
               README file for Bundle Transformer: Sass and SCSS v1.12.11
   ...
   (https://github.com/Taritsyn/LibSassHost) version 1.3.0 (supports the LibSass
   ...
   RELEASE NOTES
   =============
   LibSass Host was updated to version 1.3.0.
