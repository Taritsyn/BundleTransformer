   ...
   --------------------------------------------------------------------------------
              README file for Bundle Transformer: Sass and SCSS v1.13.12
   ...
   (https://github.com/Taritsyn/DartSassHost) version 1.0.6 (supports the Dart Sass
   (https://github.com/sass/dart-sass) version 1.66.1). Also contains the
   ...
   RELEASE NOTES
   =============
   Added support for the Dart Sass version 1.66.1.
