   ...
   version 5.1 RTM). This adapter makes translation of TypeScript code to JS code.
   ...
   RELEASE NOTES
   =============
   Added support of the TypeScript version 5.1 RTM (please note: The 5.1 RTM
   release is also called '5.1.3').
