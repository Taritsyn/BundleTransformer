   ...
   --------------------------------------------------------------------------------
                README file for Bundle Transformer: TypeScript v1.11.1
   ...
   version 3.4 RTM). This adapter makes translation of TypeScript code to JS code.
   ...
   RELEASE NOTES
   =============
   Added support of TypeScript version 3.4 RTM (please note: The 3.4 RTM release is
   also called '3.4.1').
