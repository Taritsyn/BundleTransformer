   ...
   --------------------------------------------------------------------------------
                README file for Bundle Transformer: TypeScript v1.12.34
   ...
   version 4.3 RTM). This adapter makes translation of TypeScript code to JS code.
   ...
   RELEASE NOTES
   =============
   1. Added support of the TypeScript version 4.3 RTM (please note: The 4.3 RTM
      release is also called '4.3.2');
   2. In configuration settings of TypeScript translator was added one new
      property - `NoImplicitOverride` (default `false`).
