   ...
   --------------------------------------------------------------------------------
                README file for Bundle Transformer: TypeScript v1.12.16
   ...
   version 3.9.6). This adapter makes translation of TypeScript code to JS code.
   ...
   RELEASE NOTES
   =============
   Added support of the TypeScript version 3.9.6.
