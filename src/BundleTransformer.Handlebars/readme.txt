   ...
   --------------------------------------------------------------------------------
                README file for Bundle Transformer: Handlebars v1.12.6
   ...
   version 4.5.3). This adapter makes translation of Handlebars templates to JS
   ...
   RELEASE NOTES
   =============
   Added support of the Handlebars version 4.5.3.
