   ...
   --------------------------------------------------------------------------------
                README file for Bundle Transformer: Handlebars v1.10.4
   ...
   version 4.1.1). This adapter makes translation of Handlebars templates to JS
   ...
   RELEASE NOTES
   =============
   Added support of Handlebars version 4.1.1.
