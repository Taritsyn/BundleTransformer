   ...
   --------------------------------------------------------------------------------
                README file for Bundle Transformer: Handlebars v1.12.8
   ...
   version 4.7.3). This adapter makes translation of Handlebars templates to JS
   ...
   RELEASE NOTES
   =============
   Added support of the Handlebars version 4.7.3.
