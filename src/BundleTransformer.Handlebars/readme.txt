   ...
   --------------------------------------------------------------------------------
                README file for Bundle Transformer: Handlebars v1.12.5
   ...
   version 4.4.5). This adapter makes translation of Handlebars templates to JS
   ...
   RELEASE NOTES
   =============
   Added support of the Handlebars version 4.4.5.
