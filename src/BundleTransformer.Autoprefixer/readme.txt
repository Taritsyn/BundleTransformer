   ...
   version 3.2.2 (supports the Andrey Sitnik's Autoprefixer
   (https://github.com/postcss/autoprefixer) version 10.4.24.0).
   ...
   RELEASE NOTES
   =============
   Added support for the Autoprefixer version 10.4.24.0.
