   ...
   version 3.2.8 (supports the Andrey Sitnik's Autoprefixer
   (https://github.com/postcss/autoprefixer) version 10.5.4).
   ...
   RELEASE NOTES
   =============
   Added support for the Autoprefixer version 10.5.4.
