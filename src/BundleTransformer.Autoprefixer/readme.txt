   ...
   --------------------------------------------------------------------------------
               README file for Bundle Transformer: Autoprefixer v1.12.51
   ...
   version 3.0.24 (supports the Andrey Sitnik's Autoprefixer
   (https://github.com/postcss/autoprefixer) version 10.4.11.0).
   ...
   RELEASE NOTES
   =============
   Added support of the Autoprefixer version 10.4.11.0.
