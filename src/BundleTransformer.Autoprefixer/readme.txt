   ...
   --------------------------------------------------------------------------------
               README file for Bundle Transformer: Autoprefixer v1.16.1
   ...
   version 3.2.3 (supports the Andrey Sitnik's Autoprefixer
   (https://github.com/postcss/autoprefixer) version 10.4.27.0).
   ...
   RELEASE NOTES
   =============
   Added support for the Autoprefixer version 10.4.27.0.
