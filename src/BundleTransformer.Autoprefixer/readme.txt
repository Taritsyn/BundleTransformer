   ...
   version 3.0.25 (supports the Andrey Sitnik's Autoprefixer
   (https://github.com/postcss/autoprefixer) version 10.4.12.0).
   ...
   RELEASE NOTES
   =============
   Added support of the Autoprefixer version 10.4.12.0.
