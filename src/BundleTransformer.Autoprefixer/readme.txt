   ...
   version 3.2.7 (supports the Andrey Sitnik's Autoprefixer
   (https://github.com/postcss/autoprefixer) version 10.5.3).
   ...
   RELEASE NOTES
   =============
   Added support for the Autoprefixer version 10.5.3.
