   ...
   --------------------------------------------------------------------------------
               README file for Bundle Transformer: Autoprefixer v1.17.3
   ...
   version 3.2.6 (supports the Andrey Sitnik's Autoprefixer
   (https://github.com/postcss/autoprefixer) version 10.5.2).
   ...
   RELEASE NOTES
   =============
   Added support for the Autoprefixer version 10.5.2.
